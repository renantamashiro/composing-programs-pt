...
Um aspecto crítico de uma linguagem de programação é o significado fornecido para os nomes se referirem aos objetos computacionais. Se um valor tem recebido um nome, nós dizemos que o nome se vincula ao valor.
